...
dofile('Utility/priorityqueue.lua')
dofile('Utility/dialogwindow.lua')
dofile('Utility/circulararray.lua')
dofile('Utility/arcingtexttag.lua')
dofile('Utility/beziercurve.lua')
...
dofile('UI/prompt.lua')
dofile('UI/simplebutton.lua')
