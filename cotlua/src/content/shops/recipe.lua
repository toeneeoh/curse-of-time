...
OnInit.final("Recipe", function(Require)
    ...
    -- savior's sword
    SetItemPrice('I02B:0', 20000)
    -- savior's armor
    SetItemPrice('I02C:0', 20000)
    -- runic white bow
    SetItemPrice('I0EY:0', 20000)
    -- runic white blade
    SetItemPrice('I074:0', 20000)
    -- mystic staff
    SetItemPrice('I03U:0', 20000)
    -- mysterious cloak
    SetItemPrice('I07F:0', 20000)
    -- vengeful paladin's hammer
    SetItemPrice('I03P:0', 20000)
    -- paladin's holy book
    SetItemPrice('I0F9:0', 20000)
    -- dwarven axe
    SetItemPrice('I079:0', 20000)
    -- dwarven warhammer
    SetItemPrice('I0FC:0', 20000)
    -- old broken gods scepter
    SetItemPrice('I00A:0', 80000)
    -- godslayer set
    SetItemPrice('I0JR:0', 100000)
    -- dwarven set
    SetItemPrice('I08K:0', 100000)
    -- dragoon set
    SetItemPrice('I0F4:0', 100000)
    -- mystic set
    SetItemPrice('I0F5:0', 100000)
    -- paladin set
    SetItemPrice('I012:0', 150000)
    -- aura of gods
    SetItemPrice('I04J:0', 400000)
    ...
    SetItemPrice('I038:0', 100)
    ShopAddItem(id2, 'I038:0', misc)
    ItemAddComponents('I038:0', "I01Y")

    -- hydra weapons
    SetItemPrice('I02N:0', 5000)
    SetItemPrice('I072:0', 5000)
    SetItemPrice('I06Y:0', 5000)
    SetItemPrice('I070:0', 5000)
    SetItemPrice('I071:0', 5000)
    ...
    SetItemPrice('I046:0', 75000)
    ShopAddItem(id2, 'I046:0', misc)
    ItemAddComponents('I046:0', "I02Q I02Q I02Q I02Q I02Q I02Q")

    -- dragon armor
    SetItemPrice('I048:0', 10000)
    SetItemPrice('I02U:0', 10000)
    SetItemPrice('I064:0', 10000)
    SetItemPrice('I02P:0', 10000)
    ...
    -- dragon weapons
    SetItemPrice('I033:0', 10000)
    SetItemPrice('I0BZ:0', 10000)
    SetItemPrice('I02S:0', 10000)
    SetItemPrice('I032:0', 10000)
    SetItemPrice('I065:0', 10000)
    ...
    -- bloody armor
    SetItemPrice('I0N4:0', {crystal = 1})
    SetItemPrice('I00X:0', {crystal = 1})
    SetItemPrice('I0N5:0', {crystal = 1})
    SetItemPrice('I0N6:0', {crystal = 1})
    ...
    -- bloody weapons
    SetItemPrice('I03F:0', {crystal = 1})
    SetItemPrice('I04S:0', {crystal = 1})
    SetItemPrice('I020:0', {crystal = 1})
    SetItemPrice('I016:0', {crystal = 1})
    SetItemPrice('I0AK:0', {crystal = 1})
