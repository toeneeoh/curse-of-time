OnInit.final("WarriorSpells", function(Require)
    ...
    do
        ...
        local buttons = {
            SimpleButton.create(LimitBreakBackdrop, "ReplaceableTextures\\CommandButtons\\BTNParryLimitBreak.blp", 0.036, 0.036, FRAMEPOINT_TOPLEFT, FRAMEPOINT_TOPLEFT, 0.012, -0.01, nil, "|cffffcc00Parry|r|n|nDamage is doubled and immunity window is extended to |cffffcc001|r second.", FRAMEPOINT_BOTTOM, FRAMEPOINT_TOP, 0., 0.01),
            SimpleButton.create(LimitBreakBackdrop, "ReplaceableTextures\\CommandButtons\\BTNSpinDashLimitBreak.blp", 0.036, 0.036, FRAMEPOINT_TOPLEFT, FRAMEPOINT_TOPLEFT, 0.054, -0.01, nil, "|cffffcc00Spin Dash|r|n|nDamage is quadrupled and enemies struck have their attack speed slowed by |cffffcc0025%|r for |cffffcc002|r seconds.", FRAMEPOINT_BOTTOM, FRAMEPOINT_TOP, 0., 0.01),
            SimpleButton.create(LimitBreakBackdrop, "ReplaceableTextures\\CommandButtons\\BTNIntimidatingShoutLimitBreak.blp", 0.036, 0.036, FRAMEPOINT_TOPLEFT, FRAMEPOINT_TOPLEFT, 0.096, -0.01, nil, "|cffffcc00Intimidating Shout|r|n|nAlso reduces the spell damage of enemies by |cffffcc0040%|r.", FRAMEPOINT_BOTTOM, FRAMEPOINT_TOP, 0., 0.01),
            SimpleButton.create(LimitBreakBackdrop, "ReplaceableTextures\\CommandButtons\\BTNWindScarLimitBreak.blp", 0.036, 0.036, FRAMEPOINT_TOPLEFT, FRAMEPOINT_TOPLEFT, 0.138, -0.01, nil, "|cffffcc00Wind Scar|r|n|nWind projectiles instead orbit around you for |cffffcc003|r seconds.", FRAMEPOINT_BOTTOM, FRAMEPOINT_TOP, 0., 0.01),
            SimpleButton.create(LimitBreakBackdrop, "ReplaceableTextures\\CommandButtons\\BTNAdaptiveStrikeLimitBreak.blp", 0.036, 0.036, FRAMEPOINT_TOPLEFT, FRAMEPOINT_TOPLEFT, 0.18, -0.01, nil, "|cffffcc00Adaptive Strike|r|n|nPassive cooldown reset chance increased to |cffffcc0050%|r.|nNow automatically casts after using a skill when available.", FRAMEPOINT_BOTTOM, FRAMEPOINT_TOP, 0., 0.01),
        }
