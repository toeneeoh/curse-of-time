...
dofile('devtools/dev.lua')
dofile('bootstrap/map_setup.lua')

dofile('config/rawcodes.lua')
dofile('config/item_schema.lua')
dofile('config/stat_schema.lua')
dofile('config/hero_definitions.lua')
dofile('config/boss_schema.lua')
dofile('gameplay/world/main_map.lua')
dofile('gameplay/players/help_text.lua')
dofile('ui/hud/hint_config.lua')
dofile('config/variables.lua')
dofile('config/save_schema.lua')
dofile('gameplay/items/item_event_registry.lua')

dofile('gameplay/combat/bonuses.lua')
dofile('gameplay/combat/buffs/buff_system.lua')
dofile('gameplay/persistence/code_gen.lua')
dofile('framework/wc3/file_io.lua')
dofile('devtools/runtime_log.lua')
dofile('devtools/dev_metric_snapshots.lua')
dofile('devtools/balance_harness.lua')
dofile('framework/wc3/game_status.lua')
dofile('framework/collections/table_helpers.lua')
dofile('framework/wc3/geometry.lua')
dofile('framework/wc3/effects.lua')
dofile('framework/wc3/groups.lua')
dofile('framework/ui/text_helpers.lua')
dofile('framework/ui/frame_helpers.lua')
dofile('framework/ui/floating_text.lua')
dofile('framework/wc3/audio.lua')
dofile('framework/wc3/unit_animation.lua')
dofile('framework/wc3/unit_helpers.lua')
...
dofile('gameplay/players/sync.lua')
...
dofile('framework/events/events.lua')
dofile('gameplay/combat/attacked.lua')
...
dofile('content/abilities/bosses/boss_abilities.lua')

dofile('gameplay/abilities/tools.lua')
dofile('gameplay/abilities/casting.lua')
dofile('gameplay/players/ability_controls.lua')
dofile('content/abilities/units/summon_abilities.lua')
dofile('gameplay/players/teleport_abilities.lua')
dofile('content/abilities/units/enemy_unit_abilities.lua')
dofile('content/abilities/units/struggle_specials.lua')
...
dofile('content/abilities/items/item_active_abilities.lua')
dofile('content/abilities/items/item_aura_abilities.lua')
dofile('content/abilities/items/socketing.lua')
dofile('gameplay/abilities/spells.lua')
...
dofile('ui/hud/hints.lua')
dofile('ui/inventory/inventory.lua')
...
dofile('content/abilities/buffs/heroes/phoenix_ranger.lua')
dofile('content/abilities/buffs/heroes/hydromancer.lua')
dofile('content/abilities/buffs/items.lua')
dofile('content/abilities/buffs/heroes/arcanist.lua')
dofile('content/abilities/buffs/heroes/thunderblade.lua')
dofile('content/abilities/buffs/heroes/bard.lua')
dofile('content/abilities/buffs/heroes/oblivion_guard.lua')
dofile('content/abilities/buffs/world/colosseum.lua')
dofile('content/abilities/buffs/world/struggle.lua')
dofile('content/abilities/buffs/heroes/assassin.lua')
dofile('content/abilities/buffs/heroes/royal_guardian.lua')
dofile('content/abilities/buffs/heroes/crusader.lua')
dofile('content/abilities/buffs/heroes/vampire.lua')
dofile('content/abilities/buffs/bosses/forgotten_mystic.lua')
dofile('content/abilities/buffs/heroes/warrior.lua')
dofile('content/abilities/buffs/heroes/bloodzerker.lua')
dofile('content/abilities/buffs/bosses/hellfire_magi.lua')
dofile('content/abilities/buffs/heroes/master_rogue.lua')
dofile('content/abilities/buffs/heroes/savior.lua')
dofile('content/abilities/buffs/heroes/elementalist.lua')
dofile('content/abilities/buffs/world/factions.lua')
dofile('content/abilities/buffs/heroes/elite_marksman.lua')
dofile('content/abilities/buffs/heroes/dark_savior.lua')
dofile('content/abilities/buffs/bosses/azazoth.lua')
dofile('content/abilities/buffs/bosses/perfect_being.lua')
dofile('content/abilities/buffs/heroes/high_priestess.lua')
dofile('content/abilities/buffs/bosses/demon_prince.lua')
dofile('content/abilities/buffs/summons.lua')
dofile('content/abilities/buffs/bosses/naga.lua')
dofile('content/abilities/buffs/bosses/love.lua')
dofile('content/abilities/buffs/world/regions.lua')
dofile('content/abilities/buffs/world/weather.lua')
dofile('content/abilities/buffs/buffs.lua')
dofile('gameplay/world/chaos.lua')
dofile('gameplay/combat/status.lua')
dofile('gameplay/combat/resource_changes.lua')
dofile('gameplay/combat/taunt.lua')
dofile('gameplay/world/colosseum.lua')
dofile('gameplay/world/struggle.lua')
dofile('gameplay/world/struggle_rewards.lua')
dofile('gameplay/world/cosmetics.lua')
dofile('gameplay/economy/currency.lua')
dofile('gameplay/economy/honor.lua')
dofile('gameplay/economy/effects.lua')
dofile('gameplay/world/destructables.lua')
dofile('gameplay/world/world_destructables.lua')
...
dofile('gameplay/players/reward_scaling.lua')
...
dofile('gameplay/factions/faction.lua')
dofile('gameplay/factions/cave_voyagers.lua')
dofile('gameplay/factions/mining.lua')
dofile('gameplay/factions/events.lua')
dofile('gameplay/world/hero_select.lua')
dofile('gameplay/players/hero_refresh.lua')
dofile('gameplay/items/item_lookup.lua')
...
dofile('content/shops/recipe.lua')
dofile('content/shops/town.lua')
dofile('content/shops/colosseum.lua')
dofile('content/shops/faction.lua')
dofile('content/shops/evil_shopkeeper.lua')
dofile('content/rewards/honor_milestones.lua')
