...
dofile('content/abilities/heroes/darksavior.lua')
dofile('content/abilities/heroes/darksummoner.lua')
dofile('content/abilities/heroes/elementalist.lua')
dofile('content/abilities/heroes/elitemarksman.lua')
dofile('content/abilities/heroes/highpriestess.lua')
dofile('content/abilities/heroes/hydromancer.lua')
dofile('content/abilities/heroes/masterrogue.lua')
dofile('content/abilities/heroes/oblivionguard.lua')
dofile('content/abilities/heroes/phoenixranger.lua')
dofile('content/abilities/heroes/royalguardian.lua')
...
dofile('content/abilities/items/item_spells.lua')
