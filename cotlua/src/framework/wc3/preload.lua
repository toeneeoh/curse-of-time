OnInit.global("Preloader", function()
    ...
    preload("war3mapImported\\AnnihilationBlast.mdx")
    preload("unholy_ascension.mdl")
    preload("Blood Wing.mdx")
    preload("war3mapImported\\Blood Presence.mdx")
    ...
    preload("Indicators\\line closed.mdx")
    preload("war3mapImported\\WindShell.mdx")
    preload("war3mapImported\\Rebirth.mdx")
    preload("buildings\\demon\\CorruptedMoonWell\\CorruptedMoonWell.mdl")
    ...
    preload("Objects\\InventoryItems\\TreasureChest\\treasurechest.mdl")
    preload("war3mapImported\\Armor Penetration Orange.mdx")
    preload("Abilities\\Spells\\NightElf\\Blink\\BlinkCaster.mdl")
    preload("Abilities\\Spells\\NightElf\\FanOfKnives\\FanOfKnivesCaster.mdl")
