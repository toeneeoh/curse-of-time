...
OnInit.global("Variables", function()
    ...
    TYPE_NAME[10] = "Staff"
    TYPE_NAME[11] = "Potion"
    TYPE_NAME[12] = "Socketable"
    TYPE_ALL = 0x1FFF
    TYPE_EQUIPPABLE = 0x3FF
    TYPE_POTION = 0x400
    --...
    ITEM_MODEL[1] = FourCC('rar1')
    ITEM_MODEL[2] = FourCC('rar2')
    ITEM_MODEL[3] = FourCC('rar3')
    ITEM_MODEL[4] = FourCC('rar4')
    ITEM_MODEL[5] = FourCC('rar5')
    --...
    RARITY_NAME[0] = ""
    RARITY_NAME[1] = "|cff40bf5fRefined|r"
    RARITY_NAME[2] = "|cff4087bfRare|r"
    RARITY_NAME[3] = "|cff7040bfEpic|r"
    RARITY_NAME[4] = "|cffbf6b40Legendary|r"
    RARITY_NAME[5] = "|cffc41919Chaos|r"
    --...
